            ...
            <div className="w-full max-w-4xl grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-6 p-6 hidden md:block">
                    <div className="space-y-2">
                        ...
                        <p className="text-xl text-slate-600 mt-2">Your AI-powered interview assistant</p>
                    </div>
                    ...
                    <div className="mt-8 space-y-4">
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                <h3 className="font-medium text-slate-800">AI-Generated Questions</h3>
                                <p className="text-slate-600 text-sm">Based on your job description</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                <h3 className="font-medium text-slate-800">Personalized Feedback</h3>
                                <p className="text-slate-600 text-sm">Improve with each practice session</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                <h3 className="font-medium text-slate-800">Detailed Analysis</h3>
                                <p className="text-slate-600 text-sm">Get insights on your performance</p>
                            </div>
                        </div>
                    </div>
                </div>
